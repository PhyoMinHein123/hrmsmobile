      ...
      <View style={{flex:1}}>
        <DrawerContentScrollView 
          ...
          >
            ...
            />
            <Text style={{color: '#fff', fontSize: 15, fontFamily:'Roboto-Medium'}}>Phyo Min Hein</Text>
            <Text style={{color: '#fff', fontSize: 12, fontFamily:'Roboto-Regular'}}>phyominhein@gmail.com</Text>
          </ImageBackground>
        ...
        <View style={{padding: 2, borderTopWidth: 1, borderTopColor: '#ccc'}}>
          <DrawerItem label="Help" onPress={() => Alert.alert("Hello")} icon={()=>(<Ionicons name="home-outline" size={22} />)}/>
